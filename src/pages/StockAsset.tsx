import { ScanLine, Eye, Package, Cpu, BarChart3, Truck, Warehouse } from "lucide-react";
import Header from "@/components/Header";
import CountdownTimer from "@/components/CountdownTimer";

const features = [
  { icon: <Eye className="w-6 h-6" />, title: "Computer Vision", desc: "AI-powered visual recognition for real-time stock and asset identification." },
  { icon: <Package className="w-6 h-6" />, title: "Inventory Monitoring", desc: "Track inventory levels, movements, and anomalies automatically." },
  { icon: <Cpu className="w-6 h-6" />, title: "Edge Devices", desc: "Deploy edge computing devices for on-premise intelligent monitoring." },
  { icon: <BarChart3 className="w-6 h-6" />, title: "Real-Time Analytics", desc: "Live dashboards and insights for operational decision-making." },
  { icon: <Truck className="w-6 h-6" />, title: "Movement Tracking", desc: "Monitor asset and stock movement across facilities in real time." },
  { icon: <Warehouse className="w-6 h-6" />, title: "MSME Focused", desc: "Purpose-built infrastructure designed for small and medium enterprises." },
];
  ...
  <main className="bg-background min-h-screen">
    ...
    <section className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 text-center max-w-3xl">
        ...
        <p className="text-sm font-body text-teal/80 mb-4 opacity-0 animate-fade-in-up" style={{ animationDelay: "200ms" }}>AI-Powered MSME Infrastructure</p>
        ...
        <p className="text-sm font-body italic text-teal mt-4 opacity-0 animate-fade-in-up" style={{ animationDelay: "350ms" }}>
          Edge AI for Enterprise Efficiency.
        </p>
      </div>
    </section>
    ...
    <section className="py-20">
      <div className="container mx-auto px-6 max-w-5xl">
        <h2 className="font-display text-2xl sm:text-3xl font-semibold text-foreground text-center mb-14">Capabilities</h2>
